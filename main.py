...
file_path = os.path.abspath('nlp_model.pkl')
...
def rcmd(m):
    m = m.lower()
    data, similarity = create_similarity()  # Moved data and similarity initialization here
...
# Converting a list of strings to a list (e.g., '["abc","def"]' to ["abc","def"])
...
def recommend():
    ...
    # Combining multiple lists as a dictionary for easier processing and preserving order
